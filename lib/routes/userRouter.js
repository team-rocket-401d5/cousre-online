...
router.get('/:user/courses', bearerMW, getCoursesHandler);//bearerMW,
router.get('/:user/courses/:course', bearerMW, getCourseHandler);//bearerMW,
router.post('/:user/courses/:course', bearerMW,publishCourseHandler);
router.put('/:user/courses/:course',bearerMW, updateCourseHandler);
router.delete('/:user/courses/:course',bearerMW, deleteCourseHandler);
router.get('/:user/courses/:course/:vidID',bearerMW, getVideoHandler); //put back the bearerMW ,
router.patch('/:user/courses/:course/:vidID/isWatched',bearerMW, updateIsWatchedHandler); //put back the bearerMW ,
router.patch('/:user/courses/:course/:vidID/notes',bearerMW, UpdateNoteHandler); //put back the bearerMW
